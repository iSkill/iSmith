...
@ScriptManifest(author = "iSkill", category = Category.SMITHING, description = "Smelts iron/gold/rune bars", name = "iSmith", servers = { "PKHonor" }, version = 1)
...
public class iSmith extends Script implements Paintable, MessageListener{
    ...
    public void paint(Graphics g1) {
       if (guiWait == false)
       {
        ...
        g.drawString("Version: " + "1", 317, 452);
...
public static class iSmithGUI extends JFrame {
	...
	public iSmithGUI() {
		...
		oreToSmelt.setModel(new DefaultComboBoxModel(new String[] { "SMITHING NOT ENABLED", "Rune bar", "Adamant bar", "Mithiril bar", "Gold bar", "Iron bar", "Steel bar", "Bronze bar"}));
		...
		checkEnableSmithing.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (checkEnableSmithing.isSelected()) {
					...
					oreToSmelt.setModel(new DefaultComboBoxModel(new String[] {"Rune bar", "Adamant bar", "Mithiril bar", "Gold bar", "Iron bar", "Steel bar", "Bronze bar"}));
